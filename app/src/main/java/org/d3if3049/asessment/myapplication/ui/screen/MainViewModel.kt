...
class MainViewModel : ViewModel()  {
    ...
    var data = mutableStateOf(emptyList<Hudan>())
        private set
    ...
    fun retrieveData(userId: String) {
        viewModelScope.launch(Dispatchers.IO) {
            ...
            try {
                data.value = HudanApi.service.getHudan(userId)
    ...
    fun saveData(userId: String, judul: String, deskripsi: String, bitmap: Bitmap) {
        viewModelScope.launch(Dispatchers.IO) {
            try {
                val result = HudanApi.service.postHudan(
                    userId,
    ...
    fun deleteData(userId: String, hudanId: String) {
        viewModelScope.launch(Dispatchers.IO) {
            try {
                Log.d("MainViewModel", "Attempting to delete hewan with ID: $hudanId using user ID: $userId")
                val result = HudanApi.service.deleteHudan(userId, hudanId)
